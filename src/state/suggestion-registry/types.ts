...
export type Scope =
  ...
  /**
   * Активный тег «Логика кампании» на карточке кампании — подсказки правок
   * СТРУКТУРЫ графа (шаг/ветвление/задержка/канал/порядок). Правка уходит в тот
   * же ИИ-движок графа; применяет её headless-аппликатор карточки (spec §2).
   */
  | { kind: "campaign-logic" }
  /**
