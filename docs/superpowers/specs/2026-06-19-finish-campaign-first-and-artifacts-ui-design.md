...
**Ветка реализации:** будет создана воркстри `feature/finish-campaign-first` на этапе writing-plans (AGENTS.md требует worktree для параллельной работы; среда — см. §10).
