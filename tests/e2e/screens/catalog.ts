...
export const SCREENS: Screen[] = [
  ...
  },
  {
    ...
    // В @visual включён финальным фикс-раундом: это ЕДИНСТВЕННЫЙ экран
    // каталога, где видны цветные по каналам пилюли шаблонов у ЧЕРНОВИКА
    // (кликабельные, с поповером выбора) — главный визуальный результат ветки
    // «Сценарий кампании». Без базлайна перекраска палитры здесь никем не
    // сторожилась.
    expand: true,
  },
  {
